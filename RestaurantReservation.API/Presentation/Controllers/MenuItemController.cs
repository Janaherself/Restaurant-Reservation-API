...
namespace RestaurantReservation.API.Presentation.Controllers
{
    ...
    /// </summary>
    /// <param name="_menuItemService"></param>
    [Authorize]
    [ApiController]
    [Route("api/menu-items")]
    [Produces("application/json")]
    public class MenuItemController(IMenuItemService _menuItemService) : Controller
    {
        /// <summary>
        ...
        public async Task<ActionResult<IEnumerable<MenuItemReadDto>>> GetMenuItems([FromQuery] int pageNumber = 1, [FromQuery] int pageSize = 10)
        {
